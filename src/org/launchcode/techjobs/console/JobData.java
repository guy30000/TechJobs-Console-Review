...
public class JobData {
    ...
    public static ArrayList<String> findAll(String field) {
        ...
        for (HashMap<String, String> row : allJobs) {
            ...
            if (!values.contains(aValue)) {
                values.add(aValue);
                //prints out when list by type All x Values = aValue
                //System.out.println(aValue + "XXXXXXXXXXXXX");
            }
        }
    ...
    public static ArrayList<HashMap<String, String>> findAll() { //ignore this, you dont need it
        // load data, if not already loaded
        loadData();        return allJobs;    }
     ...
     *
     * @param column   Column that should be searched.                   //this looks inportant
...
//added the case sensitivity to this line
